...
export class CreateClientePedidoTable1783399210817 implements MigrationInterface {
    name = 'CreateClientePedidoTable1783399210817'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pedidos" ("id" SERIAL NOT NULL, "fechas" character varying NOT NULL, "estado" integer NOT NULL, "observaciones" character varying NOT NULL, "clienteId" integer, CONSTRAINT "PK_ebb5680ed29a24efdc586846725" PRIMARY KEY ("id"))`);
